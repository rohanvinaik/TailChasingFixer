...
def main():
    ...
    # Updated to match actual issue types generated by analyzers
    fixable_types = {
        'semantic_duplicate_function', 'duplicate_function', 
        'semantic_hv_duplicate', 'semantic_hv_exact',
        'phantom_function', 'enhanced_placeholder', 'phantom_stub_triage',
        'missing_symbol', 'circular_import', 'prototype_fragmentation',
        'hallucination_cascade', 'import_anxiety', 'import_anxiety_class_import_spree',
        'import_anxiety_unused_imports', 'import_anxiety_error_handling_anxiety',
        'repeated_import_pattern', 'large_import_block', 'wrapper_abstraction',
        'context_window_thrashing', 'function_coupling_risk', 'error_handling_anxiety',
        'llm_filler_sequence', 'llm_filler_text', 'llm_filler_docstring', 'llm_filler_json'
    }
